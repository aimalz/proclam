...
\label{sec:nois_datay}
 ...
 \aim{I am not sure how to  make the distinction between "almost perfcet classifier" and "noisy classifier". Is there a threshold for the probability values to distinguish between the two?}
...
\aim{It's unclear how the three-class case of SNPhotCC is relevant.  We should perhaps do this for Ashish's confusion matrices for more classes.}
