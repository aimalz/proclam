...
\aim{Anita Bahmanyar will write the descriptions of and motivation for the confusion matrix-based systematics tests.}

\aim{Describe what mock data is: probability vectors}

\aim{Describe how data is generated: start from confusion matrix\dots}
