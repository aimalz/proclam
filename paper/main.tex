...
% TODO define probabilistic data product
  ...
  Using mock classification results, we find that multiple metrics yield qualitatively consistent results, enabling \textsc{PLAsTiCC} to choose a weighted modification of the log-loss as a metric due to its ease of interpretability.
