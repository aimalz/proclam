...
\begin{abstract}
  ...
  Using mock classification probability submissions exhibiting systematics anticipated of \textsc{PLAsTiCC}, we investigate two metrics of posterior probability vectors.
  ...
  Thus we choose for \textsc{PLAsTiCC} a weighted modification of the log-loss as a metric due to the availability of a meaningful interpretation.
