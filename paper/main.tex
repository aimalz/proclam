...
\begin{abstract}
  ...
  Using mock classification probability submissions exhibiting the systematics anticipated of \textsc{PLAsTiCC}, we investigate two metrics of classification probability estimates.
  We compare their sensitivity to the isolated systematics and combinations thereof, ultimately making the reassuring discovery that multiple metrics yield qualitatively consistent results.
  Thus we choose for \textsc{PLAsTiCC} a weighted modification of the log-loss as a metric due to the availability of a meaningful interpretation and superior sensitivity to the most concerning systematics.
