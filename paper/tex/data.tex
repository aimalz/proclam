...
\textbf{[RH: need to clear up confusion matrix stuff here]}
We present eight different `mock classifiers', each of whose efficacy is described by its psuedo confusion matrix $\mathbb{C}$.
