...
Thus, a metric \sout{tuned to} \changes{evaluating} anomaly detection would aim to \changes{\emph{minimize the false negative rate and maximize the true positive rate.}}
