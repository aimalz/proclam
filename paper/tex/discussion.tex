...
The metrics investigated here are specific to \plasticc, in which participants compete to classify complete lightcurves similar to light curves in LSST data releases without regard for the impacts of misclassification on specific science results.
