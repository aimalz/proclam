...
\changes{In this scientific application, a classifier that maximizes true positives and minimizes false positives boosts the constraining power over cosmological parameters.
However, it does so at a cost of rising false negatives, which represent constraining power forgone.
...
\changes{The discovery of pulsars serves as an example of novelty detection enabled by a human classifier \citep{bell_burnell_measurement_1969}.}
