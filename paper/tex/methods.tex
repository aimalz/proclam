...
The goal of \snphotcc\ was to identify good classifiers of photometrically identified SN Ia used for cosmology analysis. The classifiers were ranked using a metric that optimizes the purity of any resultant data set.
