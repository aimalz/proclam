...
\begin{figure*}
	\begin{center}
		...
		Each point represents a classifier with baseline behavior (regular polygon marker; triangle for perfect behavior, square for noisy behavior, diamond for almost perfect behavior) for all but one class with a particular systematic (asterisk markers; ).
