...
It is immediately evident that the log-loss has more dynamic range than the Brier score overall.
Though the linearity is not surprising, there is information to be gleaned from the slopes and extents.
